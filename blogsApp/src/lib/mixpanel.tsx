...
export const mixpanelPostLikes = whenEnabled((post: TrpcRouterOutput['setLikePost']['post']) => {
  mixpanel.track('Like', { postId: post.id })
})

export const mixpanelPostDisLike = whenEnabled((post: TrpcRouterOutput['setDisLikePost']['post']) => {
  mixpanel.track('DisLike', { postId: post.id })
})
